...
export const PermissionFeatureModel = defineModel({
  name: 'PermissionFeature',
  table: 'permission_features',
  columns: {
...
export type PermissionFeatureRecord = InferModelShape<typeof PermissionFeatureModel>;
